...
import { BookMarked, CheckCircle, Loader2, HelpCircle, BookOpen, FileText, Code2, Sparkles } from 'lucide-react'
      ...
      {selectMode && (
        <div className="flex items-center justify-end gap-2 flex-wrap">
          <label className="flex items-center gap-1.5 text-xs cursor-pointer">
            <input
              type="checkbox"
              checked={selected.size === filteredPairs.length && filteredPairs.length > 0}
