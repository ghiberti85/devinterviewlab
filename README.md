...
**CI:** ![Tests](https://img.shields.io/badge/tests-318%20passing-brightgreen) ![TypeScript](https://img.shields.io/badge/TypeScript-zero%20errors-blue) ![Deploy](https://img.shields.io/badge/deploy-Vercel-black)
...
__tests__/unit/   # 318 Vitest unit tests
```
...
| `api-topics.test.ts` | 8 | 401/400 guards, translation-gap backfill on POST, self-healing + cap on GET `/api/topics` |
