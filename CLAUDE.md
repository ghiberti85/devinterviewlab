...
| Testes | Vitest (`__tests__/unit/`) — **331 testes, zero falhas toleradas** |
...
```bash
npm test              # 331 testes devem passar — zero falhas toleradas
...
### Contagem atual: **331 testes** — atualizar este número a cada PR
