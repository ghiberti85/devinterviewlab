...
| Testes | Vitest (`__tests__/unit/`) — **330 testes, zero falhas toleradas** |
...
```bash
npm test              # 330 testes devem passar — zero falhas toleradas
...
### Contagem atual: **330 testes** — atualizar este número a cada PR
